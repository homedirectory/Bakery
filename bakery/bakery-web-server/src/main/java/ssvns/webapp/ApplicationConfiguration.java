package ssvns.webapp;

import java.util.Properties;

import org.restlet.Component;

import ssvns.config.ApplicationDomain;
import ssvns.webapp.WebUiResources;
import ssvns.dbsetup.HibernateSetup;
import ssvns.filter.NoDataFilter;
import ssvns.ioc.WebApplicationServerModule;
import ssvns.serialisation.SerialisationClassProvider;
...
/**
 * Configuration point for Bakery Management System Web Application.
 * 
 * @author Generated
 * 
 */
        ...
        try {
            ...
            getDefaultHost().attach(
                    new WebUiResources(
                            ...
                            "An application server for Bakery Management System",
                            "SSSVN",
                            "Authors",
                            webApp
                            ));
