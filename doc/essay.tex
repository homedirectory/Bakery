...
\title{User Guide for the Bakery System}
\author{Sofiia Tatosh, Sofiya Garkot, Solomiia Shuptar, Vladyslav Bilyk, Nazar Todoshchuk}
\date{\today}
\usepackage{hyperxmp}
\hypersetup{
    pdftitle={User Guide for the Bakery System},
    pdfauthor={Sofiya Garkot, Solomiia Shuptar},
    pdfsubject={Once sentence description on the manual.},
    pdfcopyright={Copyright (C) 2020 SSSVN.  All rights reserved.}
}
...
\begin{document}
	\onehalfspacing
	\pagenumbering{roman}
    \include{sections/00-toc/toc}
    \pagenumbering{arabic}
    \include{sections/01-chapter/chapter-01}
    %\include{sections/02-chapter/chapter-02}
\end{document}
