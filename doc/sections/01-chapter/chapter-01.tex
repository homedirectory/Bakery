...
- orderNo → string that represents the order code number in the format ‘ORD-ХХХХХХХ’. By default it is automatically generated, but can be set up by User during man
